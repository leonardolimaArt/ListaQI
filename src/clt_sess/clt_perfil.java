...
public class clt_perfil extends JFrame implements ActionListener, MouseListener  {

    public JButton Atualizar_b, foto_perfil_b;
    public JPanel MeuPerfil_P;
    ImageIcon tituloSys_2, tituloSys_3, newimgBDIconeFinal;
    public JTextField field_0_nome,field_1_email,field_2_estado,field_3_cidade,field_4_bairro,field_5_logradouro, field_6;
    ...
    public clt_perfil(JPanel emp_perfil_g, getset_form_clt usr) {
        ...
        texto_0_1 = new JLabel(" "+usr.getNome_clt());//NOME FIELD
        texto_0_1.setBounds(180, 50, 180, 40);
        texto_0_1.setForeground(Color.black);
        texto_0_1.setFont(new Font("Arial", Font.ITALIC, 16));
        MeuPerfil_P.add(texto_0_1);

        JLabel texto_1 = new JLabel("Código: "+String.valueOf(usr.getCodigo_clt()));
        ...
        field_0_nome = new JTextField(17);
        field_0_nome.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_0_nome.setText(usr.getNome_clt());
        MeuPerfil_P.add(field_0_nome);
        field_0_nome.setBounds(35,180,185,25);
        ...
        field_1_email = new JTextField(17);
        field_1_email.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_1_email.setText(usr.getEmail_clt());
        MeuPerfil_P.add(field_1_email);
        field_1_email.setBounds(255,180,185,25);
        ...
        field_2_estado = new JTextField(17);
        field_2_estado.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_2_estado.setText(usr.getEstado_clt());
        MeuPerfil_P.add(field_2_estado);
        field_2_estado.setBounds(35,270,185,25);
        ...
        field_3_cidade = new JTextField(17);
        field_3_cidade.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_3_cidade.setText(usr.getCidade_clt());
        MeuPerfil_P.add(field_3_cidade);
        field_3_cidade.setBounds(255,270,185,25);
        ...
        field_4_bairro = new JTextField(17);
        field_4_bairro.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_4_bairro.setText(usr.getBairro_clt());
        MeuPerfil_P.add(field_4_bairro);
        field_4_bairro.setBounds(35,325,185,25);
        ...
        field_5_logradouro = new JTextField(17);
        field_5_logradouro.setBorder(new MatteBorder(0,0,1,0,Color.black));
        field_5_logradouro.setText(usr.getLogradouro_clt());
        MeuPerfil_P.add(field_5_logradouro);
        field_5_logradouro.setBounds(255,330,185,20);
    ...
    public void actionPerformed (ActionEvent e) {
        if (e.getSource() == Atualizar_b) {
            ...
            usr_obj.setNome_clt(field_0_nome.getText());
            usr_obj.setEmail_clt(field_1_email.getText());
            usr_obj.setEstado_clt(field_2_estado.getText());
            usr_obj.setCidade_clt(field_3_cidade.getText());
            usr_obj.setBairro_clt(field_4_bairro.getText());
            usr_obj.setLogradouro_clt(field_5_logradouro.getText());

            sysDAO_sess.saveImgPerfil_clt(usr_obj, caminho_img);
            sysDAO_sess.update_clt(usr_obj);

            texto_0_1.setText(" "+field_0_nome.getText());
            ...
            if (textoPatternFinal.matcher(field_6.getText()).matches() == true && field_6.getDocument().getLength() > 6) {
                ...
                usr_obj.setSenha_clt(field_6.getText());
                sysDAO_sess.updateSenha_clt(usr_obj);
